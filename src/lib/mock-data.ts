...
export const initialFileStatuses: FileStatus[] = [
  ...
  { id: '3', name: 'Client_Feedback_Round2.pdf', status: 'published', source: 'Local Import', lastUpdated: new Date(Date.now() - 120000).toISOString() },
  ...
  { id: '6', name: 'Lower_Thirds.ae', status: 'processing', source: 'Local Import', lastUpdated: new Date(Date.now() - 60000).toISOString() },
